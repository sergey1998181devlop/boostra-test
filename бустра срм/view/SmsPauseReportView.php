...
class SmsPauseReportView extends View
{
    ...
    public function fetch(): string
    {
        ...
        return $this->design->fetch('sms_pause_report.tpl');
    }
    ...
    private function getResults(int $currentPage)
    {
        ...
        $this->db->query("
            ...
            WHERE cl.`type` = 'pause_sms_subscription'
    ...
    private function getTotals(): int
    {
        $query = $this->db->placehold("
            ...
            FROM s_changelogs 
            WHERE `type` = 'pause_sms_subscription' 
    ...
    private function download(): void
    {
        ...
        $filename = 'pause_sms_subscription_' . date('Y-m-d') . '.xlsx';
