...
class Request {
    ...
    /**
     * Detects whether to return JSON body or $_REQUEST (for form-data)
     */
    private function detectRequestData(): array
    {
        $contentType = $_SERVER['CONTENT_TYPE'] ?? '';

        if (str_contains($contentType, 'application/json') && !$this->isGet()) {
