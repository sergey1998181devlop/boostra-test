...
class Request extends Simpla
{
   ...
   public function json_output($data)
    ...
    /**
     * Проверить валидность Bearer токена
     * @return bool
     */
    public function verifyBearerToken(): bool
    {
        ...
        $query = $this->db->placehold(
            "SELECT COUNT(*) as count FROM application_tokens
    ...
    /**
     * Получить данные запроса (JSON или POST)
