{$meta_title='Статистика по Вита-мед' scope=parent}
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">
                    ...
                    <span>Статистика по Вита-мед</span>
                </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Статистика по Вита-мед</li>
                </ol>
            </div>
        </div>
        <div class="row">
