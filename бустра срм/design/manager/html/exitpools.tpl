{$meta_title='Опросы клиентов' scope=parent}
                    ...
                    <div class="card-body">
                        ...
                        <div id="basicgrid" class="jsgrid" style="position: relative; width: 100%;">
                            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                <table class="jsgrid-table table table-striped table-hover">
                                    <tr class="jsgrid-header-row">
                                        ...
                                        <th style="width: 50px;" class="jsgrid-header-cell ">
                                            Средняя оценка
                                        </th>
                            ...
                            <div class="jsgrid-grid-body">
                                <table class="jsgrid-table table table-striped table-hover ">
                                    <tbody>
                                    {foreach $grouping_exitpools as $exitpool}
                                        <tr class="jsgrid-row ">
                                            <td style="width: 80px;" class="jsgrid-cell jsgrid-align-right">
                                                {$exitpool->date|date} {$exitpool->date|time}
                                            </td>
                                            ...
                                            <td style="width: 50px;" class="jsgrid-cell">
                                                {if $exitpool->mediana > 7.5}<span class="label label-success">
                                                {elseif $exitpool->mediana > 5}<span class="label label-info">
                                                {elseif $exitpool->mediana > 5}<span class="label label-warinig">
                                                {else}<span class="label label-danger">{/if}
                                                {$exitpool->mediana}
                                                </span>
                                            </td>
                                            <td style="width: 300px;" class="jsgrid-cell">
                                                <ul class="m-0 pl-1">
                                                    {foreach $exitpool->items as $item}
                                                    <li>
                                                        <small>{$item->question|escape}:</small>
                                                        <strong>{$item->response|escape}</strong>
                                                    </li>
                                                    {/foreach}
                                                </ul>
                                            </td>
