{$meta_title='Отчёт обращений клиентов для БР' scope=parent}
                                        ...
                                        <tr>
                                            {foreach from=$reportHeaders item=header}
                                                {if $header.key == 'client_name'}
                                                    <td>
                                                        {if $can_see_client_url && $row.client_id}
                                                            <a href="/client/{$row.client_id|escape}" target="_blank">
                                                ...
                                                {else}
                                                    <td>
                                                        <div class="limited-text"
                                                             onclick="openContentModal(this, '{$header.label}')"
