{$meta_title = 'JuiceScore критерии' scope=parent}
...
{capture name='page_scripts'}
    ...
    <script src="design/{$settings->theme|escape}/js/apps/juicescore_criteria.app.js"></script>
                                        ...
                                        <tr class="js-item">
                                            <td>
                                                <div class="js-visible-view js-text-name">
                                                    {$criteria->name|escape}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="text" class="form-control form-control-sm" name="name" value="{$criteria->name|escape}" />
                                                </div>
                                            </td>
                                            <td>
                                                <div class="js-visible-view js-text-required_ball">
                                                    {$criteria->required_ball|escape}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="text" class="form-control form-control-sm" name="required_ball" value="{$criteria->required_ball|escape}" />
                                                </div>
                                            </td>
                                            <td class="text-right">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Добавить критерий</h4>
            ...
            <div class="modal-body">
                <form method="POST" id="form_add_item">
                    ...
                    <div class="form-group">
                        <label for="name" class="control-label">Имя критерия</label>
                        <input type="text" class="form-control" name="name" id="name" value="" />
                    </div>
                    <div class="form-group">
                        <label for="required_ball" class="control-label">Минимальный балл</label>
                        <input type="text" class="form-control" name="required_ball" id="required_ball" value="" />
                    </div>
