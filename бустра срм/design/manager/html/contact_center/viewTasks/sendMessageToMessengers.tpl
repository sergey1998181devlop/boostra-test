                    ...
                    <div class="form-body"  id="task-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <button class="form-control" onclick="task.sendMessageToMessengers(task.getValue('message'));task.clearInput('message');task.openBlock('taskСompleted');task.closeBlock('task-info');">Отправить сообщение</button>
                                        {/if}
                                    </div>
                                </div>
                            </div>
