...
<div class="page-wrapper" id="page_wrapper">
    <div class="container-fluid">
        ...
        <div class="tab-content ">
            <div id="task" class="tab-pane active" role="tabpanel"> <div class="form-body">
                                <h3 class="card-title">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <button class="form-control" onclick="task.addBlackList()">Добавить в черный список</button>
                                    </div>
                                </div>
                            </div>
            </div>
