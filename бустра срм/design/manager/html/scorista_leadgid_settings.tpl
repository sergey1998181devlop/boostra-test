{$meta_title = 'Лидгены в скористе' scope=parent}
...
<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <ul class="mt-2 nav nav-tabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#factor-tab" role="tab" aria-selected="true">
                    <span class="hidden-sm-up"><i class="mdi mdi-animation"></i></span>
                    <span class="hidden-xs-down">Стоп-факторы</span>
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-8 col-lg-6 mt-auto mb-auto">
                                        <div class="custom-control custom-checkbox mr-sm-2">
                                            <input name="leadgid_scorista_enabled" type="checkbox" class="custom-control-input" id="leadgid_scorista_enabled" value="1" {if $leadgid_scorista_enabled}checked{/if} />
                                            <label class="custom-control-label" for="leadgid_scorista_enabled">
                                                ...
                                                <tr class="js-item">
                                                    ...
                                                    <td>
                                                        <div class="js-visible-view js-text-type">
                                                            {if $leadgid->type == 0}<span class="text-danger">При отказе</span>{else}<span class="text-success">После одобрения</span>{/if}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <select name="type" class="form-control input-sm">
                                                                <option value="0">При отказе</option>
                                                                <option value="1">При одобрении</option>
                                                            </select>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="js-visible-view js-text-utm_source">
                                                            {if $leadgid->utm_source == '*'}Любой <span class="text-muted">(*)</span>{else}{$leadgid->utm_source}{/if}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="utm_source" value="{$leadgid->utm_source|escape}" />
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="js-visible-view js-text-utm_medium">
                                                            {if $leadgid->utm_medium == '*'}Любой <span class="text-muted">(*)</span>{else}{$leadgid->utm_medium}{/if}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="utm_medium" value="{$leadgid->utm_medium|escape}" />
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="js-visible-view js-text-have_close_credits">
                                                            {if $leadgid->have_close_credits == 1}
                                                                ПК
                                                            {else}
                                                                НК
                                                            {/if}
                                                            <span class="text-muted">({$leadgid->have_close_credits})</span>
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="have_close_credits" value="{$leadgid->have_close_credits|escape}" />
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="js-visible-view js-text-min_ball">
                                                            {if $leadgid->min_ball > 0}>= {$leadgid->min_ball}
                                                            {else}<= {abs($leadgid->min_ball)}{/if}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="min_ball" value="{$leadgid->min_ball|escape}" />
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="js-visible-view js-text-amount">
                                                            {if $leadgid->amount == 0}<span class="text-danger"><strong>Отказ по заявке</strong></span>
                                                            {else}{$leadgid->amount}{/if}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="amount" value="{$leadgid->amount|escape}" />
                                                        </div>
                                                    </td>
                                                    <td class="text-right">
            ...
            <div id="factor-tab" class="tab-pane" role="tabpanel">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <dib class="card-body">
                                <h3>Список стоп-факторов</h3>
                                <div class="row">
                                    <div class="col-12 col-md-8 col-lg-6 mt-auto mb-auto">
                                        <span class="text-muted">Настройки с первой вкладки не смогут отметить скоринг как одобренный,
                                            если скористой обнаружен один из указанных стоп-факторов.</span>
                                    </div>
                                    <div class="col-12 col-md-4 col-lg-6 align-self-center">
                                        <button class="btn float-right hidden-sm-down btn-success js-open-add-factor-modal">
                                            <i class="mdi mdi-plus-circle"></i> Добавить
                                        </button>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <div class="dataTables_wrapper dt-bootstrap4 no-footer">
                                        <table id="factors-table" class="table display table-striped dataTable">
                                            <thead>
                                            <tr>
                                                <th>Название</th>
                                                <th>Комментарий</th>
                                            ...
                                            {foreach $factors as $factor}
                                                <tr class="js-item">
                                                    <td>
                                                        <div class="js-visible-view js-text-factor">
                                                            {$factor->factor}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="factor" value="{$factor->factor}" />
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="js-visible-view js-text-comment">
                                                            {$factor->comment}
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <input type="text" class="form-control form-control-sm" name="comment" value="{$factor->comment}" />
                                                        </div>
                                                    </td>
                                                    <td class="text-right">
                                                        <div class="js-visible-view">
                                                            <a href="#" class="text-info js-edit-item" title="Редактировать"><i class=" fas fa-edit"></i></a>
                                                            <a href="#" class="text-danger js-delete-factor" title="Удалить"><i class="far fa-trash-alt"></i></a>
                                                        </div>
                                                        <div class="js-visible-edit" style="display:none">
                                                            <a href="#" class="text-success js-confirm-edit-factor" title="Сохранить"><i class="fas fa-check-circle"></i></a>
                                                            <a href="#" class="text-danger js-cancel-edit-item" title="Отменить"><i class="fas fa-times-circle"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-6 mt-auto">
                                        <span class="text-white">Решение скористы <span class="text-muted">(Оригинальной)</span></span>
                                        <select name="check-type" class="form-control input-sm">
                                            <option value="0">Отказ</option>
                                            <option value="1">Одобрение</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                        ...
                                        <table class="jsgrid-table table table-striped table-hover">
                                            ...
                                            <tr class="jsgrid-filter-row" id="js-logs-search">
                                                ...
                                                <td style="width: 80px; max-width: 80px;" class="jsgrid-cell">
                                                    <input type="text" name="leadgid_id" value="{$logs_filter['leadgid_id']}" class="form-control input-sm">
                                                </td>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Добавить лидген в скористу</h4>
            ...
            <div class="modal-body">
                <form method="POST" id="form_add_item">
                    ...
                    <div class="form-group">
                        <label for="type" class="control-label text-white">Срабатывание настройки</label>
                        <select name="type" class="form-control input-sm">
                            <option value="0">При отказе</option>
                            <option value="1">При одобрении</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <span class="info">Укажите "*" если хотите затронуть всех вебмастеров в рамках лидгена.
                            <br>Это не затронет только тех вебмастеров, которые ещё не указаны в таблице.</span>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="min_ball" class="control-label text-white">Балл</label>
                        <input type="text" class="form-control" name="min_ball" id="min_ball" value="" />
                        <span class="info"><strong>Положительный балл</strong> - Настройка сработает, если балл по скористе больше указанного.
                            <br><strong>Отрицательный балл</strong> - Настройка сработает, если балл по скористе меньше указанного.</span>
                    </div>

                    <div class="form-group">
                        <label for="amount" class="control-label text-white">Рекомендуемая сумма</label>
                        <input type="text" class="form-control" name="amount" id="amount" value="" />
                        <span class="info">Укажите "0" если настройка должна делать <strong>отказ по заявке</strong>.</span>
                    </div>
...
<div id="modal_add_factor" class="modal fade bd-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">

            <div class="modal-header">
                <h4 class="modal-title">Добавить стоп-фактор</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form method="POST" id="form_add_factor">
                    <div class="alert" style="display:none"></div>

                    <div class="form-group">
                        <label for="factor" class="control-label text-white">Стоп-фактор</label>
                        <input type="text" class="form-control" name="factor" id="factor" value="" />
                        <span class="info">Название фактора из скористы.</span>
                    </div>

                    <div class="form-group">
                        <label for="comment" class="control-label text-white">Комментарий</label>
                        <input type="text" class="form-control" name="comment" id="comment" value="" />
                        <span class="info">Произвольный комментарий (Опционально).</span>
                    </div>
