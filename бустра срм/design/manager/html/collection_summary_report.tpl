{$meta_title='Сводка по взысканию' scope=parent}
        ...
        $(function () {
            ...
            function updateFilters() {
                const paramsObj = {
                    ...
                    conversation_topic: $('select.conversation_topic').val() || '',
                    ticket_type: $('select.ticket_type').val() || '',
        ...
        function download() {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    a.href = downloadUrl;
                    a.download = 'collection_summary_report_' + new Date().toISOString().slice(0, 10) + '.xlsx';
