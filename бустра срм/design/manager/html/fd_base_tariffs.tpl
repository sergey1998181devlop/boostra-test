{$meta_title = 'Настройка базовой сетки тарифов ФД'}
    ...
    <script>
        ...
        $(function () {
            ...
            $('.condition-row').click(function () {
                ...
                const isNew = row.find('td:eq(4)').text().trim() === 'Да';
                $('#edit_is_new').prop('checked', isNew);
            ...
            $('#saveConditionBtn').click(function () {
                ...
                const isNew = $('#edit_is_new').is(':checked') ? 1 : 0;
            ...
            $('#addConditionBtn').click(function () {
                ...
                const isNew = $('#new_is_new').is(':checked')  ? 1 : 0;
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-6 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">Настройка базовых тарифов для пк/нк</h3>
                <ol class="breadcrumb">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="edit_is_new">
                        <label class="custom-control-label" for="edit_is_new">Первый займ</label>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="new_is_new">
                        <label class="custom-control-label" for="new_is_new">Первый займ</label>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
