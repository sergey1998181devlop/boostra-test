    ...
    <div class="container-fluid">
        <div class="page-header">
            ...
            <div class="col-md-6 col-4 float-right">
                <form action="/tickets/save/" method="POST" id="add-ticket" class="js-order-item-form technical_support_ticket_form">
                                    ...
                                    {foreach $subjects as $group}
                                        <optgroup label="{$group.name|escape}">
                                            {foreach $group.children as $subject}
                                                <option value="{$subject.id}" {if $subject.name == 'Подача тикета'} selected {/if}>{$subject.name|escape}</option>
                                            {/foreach}
                                        </optgroup>
                                    {/foreach}
                                </select>
                            ...
                            <div class="form-input">
                                <select name="priority_id" class="form-control" id="priority" required>
                                    {foreach $priorities as $priority}
                                        <option value="{$priority->id}" {if $priority->name == 'Средний'} selected {/if}>{$priority->name|escape}</option>
                                    {/foreach}
                                </select>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input">
                                <input
                                        ...
                                        accept=".jpg, .jpeg, .png"
                                        multiple
                                        placeholder="Загрузите скриншоты ошибок..."
                                >
                            </div>
                        </div>
...
{capture name='page_scripts'}
    ...
    <script src="design/manager/js/create_ticket.js"></script>
{/capture}