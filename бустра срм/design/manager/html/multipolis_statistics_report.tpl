{$meta_title='Статистика по консьерж сервису' scope=parent}
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">
                    ...
                    <span>Статистика по консьерж сервису</span>
                </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Статистика по мультиполису</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">
                            Статистика по консьерж сервисуу
                        </h4>
                        <form id="report_form">
                            <div class="row">
