{$meta_title='Статистика по КД' scope=parent}
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">
                    ...
                    <span>Статистика по КД</span>
                </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Статистика по КД</li>
                </ol>
            </div>
        </div>
        <div class="row">
                        ...
                        <form id="report_form" action="{$smarty.server.REQUEST_URI}" method="get">
                            <div class="row">
                                <div class="col-6 col-md-auto">
                                    <div class="input-group mb-3">
                                        <input type="text" name="date_range" class="form-control daterange" value="{if $from && $to}{$from}-{$to}{/if}">
                                        <input type="hidden" value="downloadRefund" name="action" />
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <span class="ti-calendar"></span>
                                            </span>
                                ...
                                <div class="col-6 col-md-auto">
                                    <div class="btn-group">
                                        <button type="submit" class="btn btn-success"><i class="ti-save"></i> Oтчет с возвратами</button>
                                    </div>
                                </div>
                            </div>
                        </form>
