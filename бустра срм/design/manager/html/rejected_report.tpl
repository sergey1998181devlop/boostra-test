{$meta_title='Отчет по отказным заявкам' scope=parent}
                                ...
                                {if $items}
                                    {foreach $items as $item}
                                        <tr>
                                            ...
                                            <td>{$item->birth}</td>
                                            <td>{$item->reason_admin_name}</td>
                                            <td>
                                                {if $can_see_manager_url}
                                                    <a href="/manager/{$item->manager_id}">{$managers[$item->manager_id]}</a>
                                                {else}
                                                    {$managers[$item->manager_id]}
                                                {/if}
                                            </td>
                                        </tr>
                                    {/foreach}
