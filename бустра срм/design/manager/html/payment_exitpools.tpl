{$meta_title='Опросы клиентов по просрочке' scope=parent}
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0"> 
                    <span>Опросы клиентов по просрочке</span>
                </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Опросы клиентов по просрочке</li>
                </ol>
            </div>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Опросы клиентов</h4>
                            ...
                            <div class="jsgrid-grid-header jsgrid-header-scrollbar">
                                <table class="jsgrid-table table table-striped table-hover">
                                    <tr class="jsgrid-header-row">
                                        ...
                                        <th style="width: 300px;" class="jsgrid-header-cell">
                                            Ответ
                                        </th>
                                    </tr>
                                </table>
                                    ...
                                    {foreach $exitpools as $exitpool}
                                        <tr class="jsgrid-row ">
                                            <td style="width: 80px;" class="jsgrid-cell jsgrid-align-right">
                                                {$exitpool->created|date} {$exitpool->created|time}
                                            </td>
                                            <td style="width: 80px;" class="jsgrid-cell">
                                                <a href="client/{$exitpool->client->id}">
                                                    {$exitpool->client->lastname|escape}
                                                    {$exitpool->client->firstname|escape}
                                                    {$exitpool->client->patronymic|escape}
                                                </a>
                                            </td>
                                            <td style="width: 300px;" class="jsgrid-cell">
                                                {$exitpool->response}
                                            </td>
                                        </tr>
                                    {/foreach}
