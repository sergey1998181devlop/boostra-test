{$meta_title = 'Настройка базовой сетки тарифов Витамед'}
    ...
    <script>
        ...
        $(function () {
            ...
            $('#saveConditionBtn').click(function () {
                ...
                $('#editVitamedModal').modal('hide');
            });

            // Добавление новой записи
            $('#addConditionBtn').click(function () {
                const modal = $('#addVitamedModal');
                const modalBody = modal.find('.modal-body');
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-6 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">Настройка базовых тарифов Витамед для пк/нк</h3>
                <ol class="breadcrumb">
            ...
            <div class="col-md-6 col-4 align-self-center">
                <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addVitamedModal">
...
<div class="modal fade" id="editVitamedModal" tabindex="-1" role="dialog" aria-labelledby="editVitamedModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editVitamedModalLabel">Редактировать диапазон</h5>
...
<!-- Modal Добавление -->
<div class="modal fade" id="addVitamedModal" tabindex="-1" role="dialog" aria-labelledby="addVitamedModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addVitamedModalLabel">Добавить новый диапазон</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
