{$meta_title='Воронка займы Повторный клиент из CRM' scope=parent}
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">
                    ...
                    <span>Воронка займы Повторный клиент из CRM</span>
                </h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/">Главная</a></li>
                    <li class="breadcrumb-item active">Воронка займы Повторный клиент из CRM</li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-warning">Данные корректны с 18.07.2023</p>
                        <form id="report_form">
                            <div class="row">
