{$meta_title = 'Варианты ответов по просрочке' scope=parent}
...
{capture name='page_scripts'}
    ...
    <script src="design/{$settings->theme|escape}/js/apps/payment_variants.app.js"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">Варианты ответов по просрочке</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Главная</a></li>
                    <li class="breadcrumb-item active">Просрочка ответы</li>
                </ol>
            </div>
                                ...
                                <table id="config-table" class="table display table-striped dataTable">
                                    ...
                                    <tbody id="table-body">
                                        ...
                                        <tr class="js-item">
                                            ...
                                            <td>
                                                <div class="js-visible-view js-text-variant">
                                                    {$v->variant|escape}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="hidden" name="id" value="{$v->id}" />
                                                    <input type="text" class="form-control form-control-sm" name="variant" value="{$v->variant|escape}" />
                                                </div>
                                            </td>
                                            <td class="text-right">
            ...
            <div class="modal-body">
                <form method="POST" id="form_add_item">
                    ...
                    <div class="form-group">
                        <label for="variant" class="control-label">Вариант:</label>
                        <input type="text" class="form-control" name="variant" id="variant" value="" />
                    </div>
