...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Статусы тикетов</h4>
                                    ...
                                    <tbody id="table-body">
                                        ...
                                        <tr class="js-item">
                                            ...
                                            <td>
                                                ...
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="text" class="colorpicker form-control form-control" name="color" value="{$item->color}" />
                                                </div>
                                            </td>
                                            <td class="text-right">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Добавить статус тикетов</h4>
