{$meta_title = 'Темы тикетов' scope=parent}
    ...
    function TicketReasonsApp()
    {
        ...
        var _init_events = function(){
            ...
            $(document).on('click', '.js-delete-item', function(e){
                ...
                Swal.fire({
                    text: "Вы действительно хотите удалить тему "+_name+"?",
                    type: "warning",
                ...
                $.ajax({
                    ...
                    success: function(resp){
                        ...
                        else
                        {
                            ...
                            new_row += '<div class="js-visible-edit" style="display:none">';
                            new_row += '<input type="text" class="form-control form-control" name="period" value="'+resp.period+'" />';
                            new_row += '</div>';
                            new_row += '</td>';
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="text-themecolor mb-0 mt-0">Темы тикетов</h3>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Главная</a></li>
                    <li class="breadcrumb-item active">Темы тикетов</li>
                </ol>
            </div>
        ...
        <div class="row">
            ...
            <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Темы тикетов</h4>
                                        ...
                                        <tr class="js-item">
                                            ...
                                            <td>
                                                ...
                                                <div class="js-visible-edit" style="display:none">
                                                    ...
                                                    <input type="text" class="form-control form-control" name="name" value="{$item->name|escape}" />
                                                </div>
                                            </td>
                                            <td>
                                                <div class="js-visible-view js-text-period">
                                                    {$item->period|escape}
                                                </div>
                                                <div class="js-visible-edit" style="display:none">
                                                    <input type="text" class="form-control form-control" name="period" value="{$item->period|escape}" />
                                                </div>
                                            </td>
                                            <td class="text-right">
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Добавить новую причину закрытия тикетов</h4>
            ...
            <div class="modal-body">
                <form method="POST" id="form_add_item">
                    ...
                    <div class="form-group">
                        <label for="period" class="control-label">Срок рассмотрения тикета:</label>
