 ...
 */
class ScoringsCron3mt extends Simpla
{
    private const LOG_FILE = 'audit3mt.txt';
    ...
    {
        $sc_types = [
            $this->scorings::TYPE_EGRUL => 'SCORING_EGRUL',
//            $this->scorings::TYPE_FMS => 'SCORING_FMS',
            //$this->scorings::TYPE_EFRSB => 'SCORING_EFRSB',
            //$this->scorings::TYPE_FNS => 'SCORING_FNS',
        ];
		$db = $this->db;
		$const = 'constant';
