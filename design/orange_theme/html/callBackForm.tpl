        ...
        <form action="calbackForm" class="hidden" method="POST" enctype="multipart/form-data">
            ...
            <div id="steps">
                <fieldset style="display: block">
                    <div class="clearfix">
                        <label class="w-50">
                            <input required id="phone" inputmode="tel" autocomplete="tel" type="tel" name="telephone" placeholder="" value=""/>
                            <span class="floating-label">Номер телефона</span>
                        </label>
                         <label class="w-50">
                            <input required  type="text" autocomplete="email" name="email"  value=""/>
