            ...
            <div class="content">
                <div class="panel">
                    ...
                    {else}
                        ...
                        {foreach $client_visible_docs as $order_id => $data}

                                <div class="loan_docs" data-hidden="1">
                                    <h2 class="js-toggle-loan-docs"><ins>{$data['document_section_name']}</ins> <span>Нажмите, чтобы раскрыть</span></h2>
                                    <div class="loan_docs_list">
                                        <ul class="docs_list">
                        ...
                        {if empty($extra_docs) && empty($client_visible_docs)}
