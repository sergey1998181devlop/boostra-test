    ...
    <tr>
        <td class="content">
            <p>
                ...
                сообщаем, что Ваша просьба удовлетворена Кредитором.
            </p>
            <p>
                Ожидаем исполнения договорных обязательств в срок до «{$payment_date|date_format:"%d.%m.%Y"|escape} платежа с учетом отсрочки».
            </p>
        </td>
    </tr>
</table>
