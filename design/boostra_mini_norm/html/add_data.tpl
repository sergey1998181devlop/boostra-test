            ...
            <form method="post">
				<div id="steps">
					...
					<fieldset id="personal_data" style="display: block;;">
                        ...
                        <div class="clearfix">
                            <span class="title" style="float: none;">Личные данные</span>
                        ...
                        <div class="clearfix">
                            <span class="title" style="float: none;">Персональные данные</span>
                        </div>
                        {/if}
                        ...
                        <div class="clearfix row row_add-data">
                        ...
                        <div class="clearfix">
                            <span class="title" style="float: none;">Паспортые данные</span>
                            ...
                            <label>
                                ...
                                {if $error=='invalid_passport_date'}<span class="error">Некорректная дата выдачи паспорта</span>{/if}
                            </label>
                            {/if}
						...
						<div class="register">
                            ...
                            <span class="title" style="float: none;">Адрес прописки</span>
							...
							<label class="{if $user->Regcity}readonly{/if}" id="regcity-label">
                                ...
                                <span class="floating-label floating_label_add_data_fix">Город</span>
						...
						<div class="living" id="living_block">
                            ...
                            <span class="title title-fakt">Адрес проживания</span>

                            <label class="{if $error=='empty_Faktregion'}error{/if} region--label region--label_add_data_fix"  id="faktregion-label">
								<div class="select">
                        ...
                        <div class="clearfix">
                            ...
                            <span class="title" style="float: none;">Контактные лица</span>
					...
					<fieldset id="additional_data" style="display: block;;">
                        ...
                        <div class="clearfix">
                            <span class="title" style="float: none;">Данные о работе</span>
                        ...
                        <div class="register js-pensioner-hidden" {if $user->work_scope == 'Пенсионер'}style="display:none"{/if}>
                            ...
                            <span class="title" style="float: none;">Адрес Организации</span>
                        ...
                        <div class="clearfix">
                            ...
                            <span class="title" style="float: none;">Доходы</span>
