{$meta_title = "Приемная финансового омбудсмена по правам заемщиков МФО | Boostra" scope=parent}
...
<section>
    {include 'complaint/styles.tpl'}
    {include 'complaint/form.tpl'}
    {include 'complaint/script.tpl'}
</section>