    ...
    <div id="accept" class="white-popup mfp-hide">
        ...
        <div>
            <label>
                ...
                <a href="https://boostra.ru/files/docs/soglashenie-o-regulyarnyh-rekurrentnyh-platezhah-mkk-ooo-bustra.pdf" target="_blank">"Соглашением о регулярных (рекуррентных) платежах МКК ООО «БУСТРА»"</a>
            </label>
        </div>
        ...
        <div>
            <label>
                ...
                <a href="https://boostra.ru/files/docs/polozhenie-o-dopolnitelnyh-finansovyh-uslugah--mkk--ooo-bustra-sms-informirovanie-.pdf" target="_blank">"Положением о дополнительных финансовых услугах МКК ООО «Бустра» «СМС-ИНФОРМИРОВАНИЕ»"</a>
            </label>
        </div>        
        ...
        <div>
            <label>
                <div class="checkbox service_checkbox">
                    ...
                    <a href="https://boostra.ru/files/docs/pravila--195-kombinirovannogo-strahovaniya-ot-neschastnyh-sluchaev-i-boleznej.pdf" target="_blank">"Правилам №195 комбинированного страхования от несчатных случаев и болезней"</a>,
